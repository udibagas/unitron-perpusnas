...
<font face="Arial" color="#000"><span style="font-size: 14pt">FORMULIR AUDIT PERANGKAT
...
?>  <br>
<form action="?page=product_audit_process" method="POST" enctype="multipart/form-data">
        ...
        <thead>
            <tr>
                <td colspan="3" height="33" bgcolor="skyblue">
                        ...
                        <font color="#000">PROFIL PERANGKAT</font></font><font face="Arial" style="font-size: 9pt">
                    </font>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td height="23" width="77%">
                    ...
                    <input type="text" class="datepicker" name="product_audit_date" placeholder="Tanggal Audit" value="<?php if (isset($product_audit_date)) { echo $product_audit_date; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
...
&nbsp;</strong></font></td>
                ...
                <td height="23" width="77%">
                    <textarea rows="7" name="product_audit_note" cols="106" style="font-family: Arial; font-size: 9pt"><?php if (isset($product_audit_note)) { echo $product_audit_note; } ?></textarea></td>
            </tr>
            <tr>
                <td align="right" height="23" valign="top">
                    <font face="Arial" style="font-size: 9pt">
                ...
                <td height="23" width="77%">
                    <textarea rows="7" name="product_history_note" cols="105" style="font-family: Arial; font-size: 9pt"><?php if (isset($product_history_note)) { echo $product_history_note; } ?></textarea></td>
            </tr>
            <tr>
                <td height="23">&nbsp;</td>
                <td height="23">&nbsp;</td>
            ...
            <tr>
                ...
                <td height="23" width="77%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="submit" value="Simpan Audit"></span></font></td>
            </tr>
            <tr>
                <td height="23">&nbsp;</td>
                <td height="23">&nbsp;</td>
