	<?php 
		...
		$ss = $konek->query("SELECT MAX(id_req) as up FROM req_pi");
		$dd = $ss->fetch_assoc();
		 		...
		 		<div class="row">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>
                    Pengajuan Rencana Pengadaan Infrastruktur
                    <small>
                    ...
                    <?php 
                    	$sql = $konek->query("SELECT id_req FROM req_pi WHERE status='N' AND id_regis='$idd'");
                    	$num = $sql->num_rows;
                    	if($num==0){
                     ?>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-2 control-label">judul_rencana</label>
								<div class="col-sm-10">
