    ...
    <script src="js/datetimepicker/bootstrap-datetimepicker.js"></script>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#example').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "less/server_katlay.php", // Load Data
					"sServerMethod": "POST",
					"columnDefs": [
			...
			<div class="col-md-1 col-sm-12 col-xs-12"></div>
				<div class="col-md-10 col-sm-12 col-xs-12">
					<button onClick="showModals()" class="btn btn-primary">Tambah Pemilik Layanan</button>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="katlay" name="katlay" >
								</div>
							</div>
							<div class="form-group">
								<label for="npm" class="col-sm-2 control-label">Deskripsi Layanan</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nalay" name="nalay" >
								</div>
							</div>
		...
		<script>
			...
			function showModals( id )
			{
				...
				{
					$("#myModals").modal("show");
					$("#myModalLabel").html("Pemilik Layanan Baru");
					$("#type").val("new");
					waitingDialog.hide();
				}
			}
			...
			function setModalData( data )
			{
				...
				$("#id").val(data.id_kategori_layanan);
				$("#type").val("edit");
				$("#userid").val(data.id_kategori_layanan);

				$("#katlay").val(data.kategori_layanan);
				$("#nalay").val(data.nama_layanan);
				$("#myModals").modal("show");
			}
			...
			function deleteUser( id )
			{
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#katlay").val(data.kategori_layanan).attr("disabled","true");
						$("#nalay").val(data.nama_layanan).attr("disabled","true");
			...
			function clearModals()
			{
				...
				$("#katlay").val("").removeAttr( "disabled" );
				$("#nalay").val("").removeAttr( "disabled" );
