 ...
 <input type="submit" class="btn btn-info" name="t1" value="Filter"/>
                            ...
                            <?php
                                ...
                                if(isset($_POST['tgl_awal'])==false){
                                    $idd = $_SESSION['id_req'];
                                $sql=$konek->query("SELECT * FROM req_capacity WHERE id_regis='$idd'  ORDER BY tanggal_masuk DESC");
                                }else{
                                ...
                                if($tgl1 != null && $tgl2!= null){
                                  ...
                                  $sql=$konek->query("SELECT * FROM req_capacity WHERE id_regis='$idd' AND tanggal_masuk BETWEEN '$tgl1' AND '$tgl2' ORDER BY tanggal_masuk DESC");
                              }else{
                                $sql=$konek->query("SELECT * FROM req_capacity WHERE id_regis='$idd'  ORDER BY tanggal_masuk DESC");
                              }
                            ...
                            ?>
                                           <tr class="odd pointer">
                                                ...
                                                <td><a class="btn btn-info" onclick="return confirm ('Apakah Permohonan ini akan dibatalkan ?')"  href="less/aksi.php?tipe=req_capacity&module=batalkan&id=<?php echo $data['id_req']; ?>">Batalkan</a></td>
