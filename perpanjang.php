		 		...
		 		<div class="row">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>
                    Permohonan Perpanjangan Kunjungan
                    <small>
			...
			<div class="col-md-1 col-sm-12 col-xs-12"></div>
				<div class="col-md-10 col-sm-12 col-xs-12">
					...
					<table id="example"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
						...
						<div class="abcdefg">
                                    <form method="POST" action="less/aksi.php?tipe=perpanjang&module=input" class="form-horizontal form-label-left" enctype="multipart/form-data">
