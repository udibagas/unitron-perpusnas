             ...
             <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">Pemilik Layanan <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                          <input readonly class="form-control" type="text" name="pemilik" id="pemilik" placeholder="Pemilik Layanan" value="<?php echo $kategori_layanan; ?>"/> 
                       </div>
                    </div>
                     ...
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">Defenisi Layanan <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                          <input readonly class="form-control" type="text" name="defenisi_layanan" id="defenisi_layanan" placeholder="Defenisi Layanan" value="<?php echo $defenisi_layanan; ?>"/> 
                       </div>
                    </div>
                     ...
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">Level Layanan <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                       <textarea readonly class="form-control ckeditor" type="text" name="level_layanan" id="level_layanan" placeholder="Level Layanan"><?php echo $level_layanan;?></textarea>
                       </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">Tidak Termasuk Layanan <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                       <textarea readonly class="form-control ckeditor" type="text" name="tidak_layanan" id="tidak_layanan" placeholder="Tidak Termasuk Layanan"><?php echo $tidak_layanan;?></textarea>
                       </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan"> Ketersedian Layanan <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                        <textarea readonly class="form-control ckeditor" type="text" name="ketersediaan_layanan" id="tidak_layanan" placeholder="Ketersedian Layanan"><?php echo $ketersediaan_layanan;?></textarea>
                       </div>
                    </div>
                     ...
                     <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">BPP <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                        <textarea readonly class="form-control ckeditor" type="text" name="BPP" id="BPP" placeholder="Bussinness Process Procedure"><?php echo $BPP;?></textarea>
                       </div>
                    </div>
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">SOP <span class="required">*</span>
                       ...
                       <div class="col-md-8 col-sm-6 col-xs-12">
                        <textarea readonly class="form-control ckeditor" type="text" name="SOP" id="SOP" placeholder="Standart Operation Procedure"><?php echo $SOP;?></textarea>
