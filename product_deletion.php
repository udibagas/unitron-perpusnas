...
<font face="Arial" color="#fff"><span style="font-size: 14pt">FORMULIR PENGHAPUSAN PERANGKAT
...
?>  <br>
        <form action="?page=product_deletion_process" method="POST" enctype="multipart/form-data">
        ...
        <thead>
            <tr>
                <td colspan="3" height="33" bgcolor="#003366">
                        ...
                        <font face="Arial" style="font-size: 14pt">&nbsp; PROFIL 
                        PERANGKAT</font></font></td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td align="right" width="20%" height="23">
            ...
            <tr>
                ...
                <td height="23" width="76%">
                    <textarea rows="8" name="product_deletion_note" placeholder="Alasan Penghapusan" cols="96" style="font-family: Arial; font-size: 9pt"><?php if (isset($product_deletion_note)) { echo $product_deletion_note; } ?></textarea><font face="Arial"><span style="font-size: 9pt">
                    </span></font>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td height="23" width="76%">
                    ...
                    <input type="submit" value="   Simpan Data Penghapusan   "></span></font></td>
            </tr>
