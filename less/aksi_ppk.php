...
function generateRandomString($length = 10) {
   ...
   if($tipe=="request_ppk"&& $module=="input")
    {
            @session_start();
            $idd = $_SESSION['id_req'];
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
            ...
            $konek->query("INSERT INTO request SET tanggal_masuk='$tgl1',tanggal_keluar='$tgl2', id_regis='$idd',tujuan='$tujuan',  akses_ruang='$ruang',file='$nama_file',tiket='Y',step_user='ppk1permohonan',step_pj='ppk1permohonan',step='ppk1permohonan'");
            ...
            echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk1permohonan&tipe=input' />";
            }else{
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
            ...
            echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk2persetujuan&tipe=detail&id=$id_req' />";
            }else{
                echo "<script>alert('$pesan');</script>";
                echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk2persetujuan&tipe=detail&id=$id_req' />";
            }
     ...
     elseif($tipe=="pendamping"&& $module=="ganti")
    {
        ...
        $konek->query("INSERT INTO pemandu(id_regis,waktu,keterangan,status,id_req) VALUES('$pendamping',NOW(),'Pemandu Data Center','N','$id_req')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk4pemandu&tipe=detail&id=$id_req' />";
   
     }elseif($tipe=="request_ppk"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status='Y' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk3itinerary&tipe=detail&id=$id_req' />";

     }elseif($tipe=="review_ppk"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status_review='Y' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk7pengumuman&tipe=detail&id=$id_req' />";

     }elseif($tipe=="ppanjang"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status='Y',pendamping='',pengumuman='',atasan='N',status_review='N' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk4pemandu&tipe=detail&id=$id_req' />";
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk12selesai&tipe=aktif&id=$id_req' />";

    
    }elseif($tipe=="itinerary_ppk"&& $module=="input"){
        ...
        if($t=="rn"){
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk3itinerary&tipe=itinerary&id=$id_req&t=$t' />";
        }elseif($t=="ra"){
          echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk5bukutamu&tipe=itinerary&id=$id_req&t=$t' />";  
        }
    }

    elseif($tipe=="itinerary_ppk1"&& $module=="input"){
        ...
        if($t=="rn"){
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk3itinerary&tipe=itinerary&id=$id_req&t=$t' />";
          ...
          echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk8realita&tipe=itinerary&id=$id_req&t=$t' />";  
        }
    ...
    } elseif($tipe=="request_ppk"&& $module=="tolak"){
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk2persetujuan&tipe=aktif&id=$id_req' />";

    } elseif($tipe=="review_ppk"&& $module=="tolak"){
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk8realita&tipe=aktif&id=$id_req' />";
        ...
        $konek->query("INSERT INTO pp_kunjungan(id_perpanjang,id_req,alasan_perpanjang,tanggal_perpanjang,ruang_masuk,status) VALUES('$id_req2','$id_req','$alasan','$tgl1','$ruang','Y')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk8realita&tipe=detail&id=$id_req&selesai=on' />";
        ...
        $konek->query("INSERT INTO pp_kunjungan(id_perpanjang,id_req,alasan_perpanjang,tanggal_perpanjang,ruang_masuk,status) VALUES('$id_req2','$id_req','$alasan','$tgl1','$ruang','Y')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk11pperpanjang&tipe=aktif&id=$id_req' />";
    }  
	elseif($tipe=="request"&& $module=="batal"){
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET pendamping='',tiket='N',atasan='N' WHERE id_req='$id_req'");
        ...
        }elseif($tipe=="pengumuman_ppk"&& $module=="input"){
             $id_req = mysqli_real_escape_string($konek, $_POST['id']);
...
//$cek_file=mysqli_real_escape_string($konek, $_POST['file']);
 ...
 $sql1 = $konek->query("SELECT id_req+1 as ju FROM request");
            ...
            if($num>0){
                ...
                if($file!=''){
                $pesan = "";
                $nama_file = $ii1.$file.$number."pengumuman.pdf";
                $target_file = $target_dir . $nama_file;
                $uploadOk = 1;
                $imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);
                $mimetype = mime_content_type($_FILES['file']['tmp_name']);
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
            ...
            if($uploadOk=="1" || $uploadOk=="2"){
             ...
             $konek->query("UPDATE request SET pengumuman='$nama_file' WHERE id_req='$id_req'");
             echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk7pengumuman&tipe=pengumuman&id=$id_req' />";
             ...
             echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk8realita&tipe=detail&id=$id_req' />";
        }
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
    ...
    }elseif($tipe=="pengumuman"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET stat_pengumuman='Y' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=ppk7pengumuman&tipe=pengumuman&id=$id_req' />";
