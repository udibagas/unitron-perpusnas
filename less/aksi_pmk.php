...
function generateRandomString($length = 10) {
   ...
   if($tipe=="request_pmk"&& $module=="input")
    {
           @session_start();
            $idd = $_SESSION['id_req'];
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
            ...
            $konek->query("INSERT INTO request SET tanggal_masuk='$tgl1',tanggal_keluar='$tgl2', id_regis='$idd',tujuan='$tujuan',  akses_ruang='$ruang',file='$nama_file',tiket='Y',step_user='pmk1permohonan',step_pj='pmk1permohonan',step='pmk1permohonan'");
            ...
            echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk1permohonan&tipe=input' />";
            }else{
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
            ...
            echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk2persetujuan&tipe=detail&id=$id_req' />";
            }else{
                echo "<script>alert('$pesan');</script>";
                echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk2persetujuan&tipe=detail&id=$id_req' />";
            }
     ...
     elseif($tipe=="pendamping"&& $module=="ganti")
    {
        ...
        $konek->query("INSERT INTO pemandu(id_regis,waktu,keterangan,status,id_req) VALUES('$pendamping',NOW(),'Pemandu Data Center','N','$id_req')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk4pemandu&tipe=detail&id=$id_req' />";
   
     }elseif($tipe=="request_pmk"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status='Y' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk3itinerary&tipe=detail&id=$id_req' />";

     }elseif($tipe=="review_pmk"&& $module=="terima"){
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status_review='Y' WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk7pengumuman&tipe=detail&id=$id_req' />";
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk12selesai&tipe=aktif&id=$id_req' />";

    
    }elseif($tipe=="itinerary_pmk"&& $module=="input"){
        ...
        if($t=="rn"){
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk3itinerary&tipe=itinerary&id=$id_req&t=$t' />";
        }elseif($t=="ra"){
          echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk5bukutamu&tipe=itinerary&id=$id_req&t=$t' />";  
        }
    }

    elseif($tipe=="itinerary_pmk1"&& $module=="input"){
        ...
        if($t=="rn"){
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk3itinerary&tipe=itinerary&id=$id_req&t=$t' />";
          ...
          echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk8realita&tipe=itinerary&id=$id_req&t=$t' />";  
        }
    ...
    } elseif($tipe=="request_pmk"&& $module=="tolak"){
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk2persetujuan&tipe=aktif&id=$id_req' />";

    } elseif($tipe=="review_pmk"&& $module=="tolak"){
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         $konek->query("UPDATE request SET status_review='N' WHERE id_req='$id_req'");
          $konek->query("DELETE FROM enroll WHERE id_req='$id_req'");
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk8realita&tipe=aktif&id=$id_req' />";
        ...
        $konek->query("INSERT INTO pp_kunjungan(id_perpanjang,id_req,alasan_perpanjang,tanggal_perpanjang,ruang_masuk,status) VALUES('$id_req2','$id_req','$alasan','$tgl1','$ruang','Y')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk8realita&tipe=detail&id=$id_req&selesai=on' />";
        ...
        $konek->query("INSERT INTO pp_kunjungan(id_perpanjang,id_req,alasan_perpanjang,tanggal_perpanjang,ruang_masuk,status) VALUES('$id_req2','$id_req','$alasan','$tgl1','$ruang','Y')");
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk11pperpanjang&tipe=aktif&id=$id_req' />";
    }  
	elseif($tipe=="request"&& $module=="batal"){
        ...
        $no8 = mysqli_real_escape_string($konek, $_POST['no8']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pengaturan_umum' />";
        ...
        }elseif($tipe=="pengumuman_pmk"&& $module=="input"){
             $id_req = mysqli_real_escape_string($konek, $_POST['id']);
             ...
             echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk7pengumuman&tipe=pengumuman&id=$id_req' />";
             ...
             echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=pmk8realita&tipe=detail&id=$id_req' />";
        }
