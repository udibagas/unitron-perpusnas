...
if($file!=''){
$pesan = "";
$nama_file = $idd. $ii1.$file."file.pdf";
...
// if everything is ok, try to upload file
   ...
   $nama_file=''; 
    ...
    elseif($tipe=="pendamping"&& $module=="ganti")
    {
        ...
        $sql = $konek->query("SELECT * FROM pemandu WHERE id_req='$id_req' AND status='Y'");
        $nr = $sql->num_rows;
        ...
        $konek->query("INSERT INTO itinerary(id_req,waktu,lokasi,detail_aktifitas,status) VALUES('$id_req','$tgl','$lokasi','$detail','Y')");

         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=itinerary&id=$id_req' />";
        ...
        $id_req = mysqli_real_escape_string($konek, $_POST['id_req']);
         ...
         echo "UPDATE request SET status='P',alasan_perpanjang='$alasan', perpanjang='$tgl1' WHERE id_req='$id_req'";
         //echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=detail_req&id=$id_req' />";
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=notif_tugas' />";
        ...
        $id_req = mysqli_real_escape_string($konek, $_GET['id']);
         ...
         echo "<meta http-equiv='refresh' content='0;URL=../media.php?page=manage_req' />";
