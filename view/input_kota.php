    ...
    <script src="js/datetimepicker/bootstrap-datetimepicker.js"></script>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#example').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "less/server_kota.php", // Load Data
					"sServerMethod": "POST",
					"columnDefs": [
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-2 control-label">Kode Kota</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="kode_kota" name="kode_kota" >
								</div>
							</div>
							<div class="form-group">
								<label for="npm" class="col-sm-2 control-label">Nama Kota</label>
								<div class="col-sm-10">
		...
		<script>
			...
			function setModalData( data )
			{
				...
				$("#type").val("edit");
				$("#userid").val(data.country_code);

				$("#kode_kota").val(data.country_code).attr("disabled","true");;
				$("#nama_kota").val(data.country_name);
				$("#myModals").modal("show");
			}
