    ...
    <script src="js/datetimepicker/bootstrap-datetimepicker.js"></script>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#example').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "less/server_lokasi.php", // Load Data
					"sServerMethod": "POST",
					"columnDefs": [
			...
			<div class="col-md-1 col-sm-12 col-xs-12"></div>
				<div class="col-md-10 col-sm-12 col-xs-12">
					<button onClick="showModals()" class="btn btn-primary">Tambah Lokasi</button>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-2 control-label">No Lokasi</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="no_lokasi" name="no_lokasi" >
								</div>
							</div>
							<div class="form-group">
								<label for="npm" class="col-sm-2 control-label">Nama Lokasi</label>
								<div class="col-sm-10">
		...
		<script>
			...
			function setModalData( data )
			{
				...
				$("#id").val(data.lokasi_id);
				$("#type").val("edit");
				$("#userid").val(data.lokasi_id);

				$("#no_lokasi").val(data.lokasi_no);
				$("#nama_lokasi").val(data.lokasi_name);
				$("#myModals").modal("show");
			}
			...
			function deleteUser( id )
			{
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#no_lokasi").val(data.lokasi_no).attr("disabled","true");
						$("#nama_lokasi").val(data.lokasi_name).attr("disabled","true");
			...
			function clearModals()
			{
				...
				$("#no_lokasi").val("").removeAttr( "disabled" );
				$("#nama_lokasi").val("").removeAttr( "disabled" );
