...
if (!isset($_REQUEST['idb'])) {
    ...
    echo "<meta http-equiv='refresh' content='0;URL=media.php?page=pbk9inventory&tipe=detail&id=$_SESSION[id]' />";
    exit();
}
...
<br>
<form action="view/bpp31/product_maintenance_process.php" method="POST" enctype="multipart/form-data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td height="23" width="75%">
                    ...
                    <input type="text" name="product_maintenance_price" placeholder="Biaya Pemeliharaan" value="<?php if (isset($product_maintenance_price)) { echo $product_maintenance_price; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" name="product_maintenance_tax" placeholder="Pajak Biaya Pemeliharaan" value="<?php if (isset($product_maintenance_tax)) { echo $product_maintenance_tax; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" name="product_maintenance_contract_num" placeholder="Pajak Biaya Pemeliharaan" value="<?php if (isset($product_maintenance_contract_num)) { echo $product_maintenance_contract_num; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" class="datepicker" name="product_maintenance_start_date" placeholder="Tanggal Mulai Pemeliharaan" value="<?php if (isset($product_maintenance_start_date)) { echo $product_maintenance_start_date; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" class="datepicker" name="product_maintenance_finish_date" placeholder="Tanggal Selesai Pemeliharaan" value="<?php if (isset($product_maintenance_finish_date)) { echo $product_maintenance_finish_date; } ?>">
                    </span></font>
                </td>
            </tr>
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" class="datepicker" name="product_maintenance_next_date" placeholder="Tanggal Pemeliharaan Selanjutnya" value="<?php if (isset($product_maintenance_next_date)) { echo $product_maintenance_next_date; } ?>"> (optional)
                    </span></font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td height="23" width="75%">
                    <font face="Arial"><span style="font-size: 9pt">
                    <input type="text" class="datepicker" name="product_maintenance_post_warranty_exp_date" placeholder="Tanggal Berakhir Garansi" value="<?php if (isset($product_maintenance_post_warranty_exp_date)) { echo $product_maintenance_post_warranty_exp_date; } ?>"> (optional)
                    </span></font>
                </td>
            </tr>
            <tr>
                ...
                <td height="23" width="75%">
                    <textarea rows="6" name="product_maintenance_note" placeholder="Catatan Pemeliharaan" cols="55"><?php if (isset($product_maintenance_note)) { echo $product_maintenance_note; } ?></textarea></td>
            </tr>
            <tr>
                <td height="23">&nbsp;</td>
                <td height="23">&nbsp;</td>
