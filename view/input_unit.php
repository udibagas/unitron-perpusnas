    ...
    <script src="js/datetimepicker/bootstrap-datetimepicker.js"></script>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#example').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "less/server_unit.php", // Load Data
					"sServerMethod": "POST",
					"columnDefs": [
			...
			<div class="col-md-1 col-sm-12 col-xs-12"></div>
				<div class="col-md-10 col-sm-12 col-xs-12">
					<button onClick="showModals()" class="btn btn-primary">Tambah Unit</button>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-2 control-label">No Unit</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="no_unit" name="no_unit" onkeypress="return isNumberKey(event)">
								</div>
							</div>
							<div class="form-group">
								<label for="npm" class="col-sm-2 control-label">Nama Unit</label>
								<div class="col-sm-10">
		...
		<script>
			...
			function setModalData( data )
			{
				...
				$("#id").val(data.unit_id);
				$("#type").val("edit");
				$("#userid").val(data.unit_id);

				$("#no_unit").val(data.unit_no);
				$("#nama_unit").val(data.unit_name);
				$("#myModals").modal("show");
			}
			...
			function deleteUser( id )
			{
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#no_unit").val(data.unit_no).attr("disabled","true");
						$("#nama_unit").val(data.unit_name).attr("disabled","true");
			...
			function clearModals()
			{
				...
				$("#no_unit").val("").removeAttr( "disabled" );
				$("#nama_unit").val("").removeAttr( "disabled" );
