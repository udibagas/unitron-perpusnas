                        ...
                        <div class="abcdefg">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="POST" action="less/aksi.php?tipe=rekom_mon&module=input" class="form-horizontal form-label-left" novalidate>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                $('#datetimepicker1').datetimepicker();
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Judul Evaluasi &  Rekomendasi <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tujuan">Detail Evaluasi & Rekomendasi <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="abcdefg">
                            ...
                            <?php
                                ...
                                $sql=$konek->query("SELECT * FROM rekom_mon WHERE status='Y' AND id_req='$id_req' ORDER BY waktu DESC");
