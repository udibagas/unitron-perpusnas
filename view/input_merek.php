    ...
    <script src="js/datetimepicker/bootstrap-datetimepicker.js"></script>
		...
		<script type="text/javascript" language="javascript" >
			...
			$(document).ready(function() {
				dTable = $('#example').DataTable( {
					...
					"bJQueryUI": false,
					"responsive": true,
					"sAjaxSource": "less/server_merek.php", // Load Data
					"sServerMethod": "POST",
					"columnDefs": [
			...
			<div class="col-md-1 col-sm-12 col-xs-12"></div>
				<div class="col-md-10 col-sm-12 col-xs-12">
					<button onClick="showModals()" class="btn btn-primary">Tambah Merek</button>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="alert alert-danger" role="alert" id="removeWarning">
							...
							Anda yakin ingin menghapus Merek ini
						</div>
						<br>
						<form class="form-horizontal" id="formtim">
							...
							<div class="form-group">
								<label for="real_name" class="col-sm-2 control-label">Merek</label>
								<div class="col-sm-10">
		...
		<script>
			...
			function deleteUser( id )
			{
				...
				$.ajax({
					...
					success: function(data) {
						...
						$("#brand_name").val(data.brand_name).attr("disabled","true");
			...
			function clearModals()
			{
				...
				$("#brand_name").val("").removeAttr( "disabled" );
