...
if (!isset($_POST['sub_ruang_id'],$_POST['kelompok_biaya_id'],$_POST['sub_unit_id'],$_POST['country_id'],$_POST['brand_id'],$_POST['brand_name'],$_POST['product_model'],$_POST['product_sn'],$_POST['product_receive_date'],$_POST['product_contract_num'],$_POST['product_contract_date'],$_POST['product_price'],$_POST['product_condition_id'],$_POST['product_ownership_id'],$_POST['product_warranty_exp_date'],$_POST['product_rent_exp_date'],$_POST['product_note'])) {
	echo "<meta http-equiv='refresh' content='0;URL=../../media.php?page=ppk9inventory&tipe=produk&id=$_SESSION[id]' />";
	exit();
}
...
// }
if (!empty($errors)) {
	echo "<meta http-equiv='refresh' content='0;URL=../../media.php?page=ppk9inventory&tipe=detail&id=$_SESSION[id]&ok=gagal' />";
	exit;
} else {
	if (empty($brand_id)) {
		$exist = TRUE;
	...
	";
	if (!$konek->query($sql)) {
		echo "<meta http-equiv='refresh' content='0;URL=../../media.php?page=ppk9inventory&tipe=produk&id=$_SESSION[id]&ok=gagal1' /> />";
		exit();
	}
	...
	$konek->query($sql);
	@session_start();
	echo "<meta http-equiv='refresh' content='0;URL=../../media.php?page=ppk9inventory&tipe=detail&id=$_SESSION[id]&ok=sukses' />";
	exit();
}
?>