 ...
 <input type="submit" class="btn btn-info" name="t1" value="Filter"/>
                            ...
                            ?>
                                           <tr class="odd pointer">
                                                ...
                                                <td><a class="btn btn-info" onclick="return confirm ('Apakah Permohonan ini akan dibatalkan ?')"  href="less/aksi_ppk.php?tipe=request&module=batalkan&id=<?php echo $data['id_req']; ?>">Batalkan</a></td>
                                              ...
                                              <td class=" last"><h2><span class="fa fa-check"> Menunggu Konfirmasi</span></h2></td>
                                                ...
                                                <h2><span class="fa fa-times"> Batal</span></h2></td>
                                                    ...
                                                    <?php } ?>
                                                      ...
                                                      <td><a class="btn btn-info" href="?page=ppk1permohonan&tipe=detail&id=<?php echo $data['id_req']; ?>">Detail</a></td>
