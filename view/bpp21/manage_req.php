                            ...
                            <?php
                                ...
                                $sql=$konek->query("SELECT * FROM request ORDER BY tanggal_masuk DESC");
                                  ...
                                  echo "<h2>Tampilkan Dari Tanggal $tgl1 -> $tgl2</h2>";
                                   ...
                                   if($kode=="itinerary"){
                                        $link="?page=ppk3itinerary";
                                   }elseif($kode=="setuju"){
                                        $link="?page=ppk2persetujuan";
                                   }elseif($kode=="pemandu"){
                                        $link="?page=ppk4pemandu";
                                   }elseif($kode=="buku"){
                                        $link="?page=ppk5bukutamu";
                                   }elseif($kode=="perpanjang"){
                                        $link="?page=p7perpanjang";
                                   }elseif($kode=="pperpanjang"){
                                        $link="?page=p8pperpanjang";
                                   }elseif($kode=="review"){
                                        $link="?page=ppk6review";
                                   }elseif($kode=="pengumuman"){
                                        $link="?page=ppk7pengumuman";
                                   }elseif($kode=="realita"){
                                        $link="?page=ppk8realita";
                                   }elseif($kode=="inventory"){
                                        $link="?page=ppk9inventory";
                                   }elseif($kode=="perpanjang1"){
                                        $link="?page=ppk10perpanjang";
                                   }elseif($kode=="pperpanjang1"){
                                        $link="?page=ppk11pperpanjang";
                                   }
