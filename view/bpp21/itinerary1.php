                        ...
                        <div class="abcdefg">
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form method="POST" action="less/aksi_ppk.php?tipe=itinerary_ppk1&module=input<?php if($dcek>0){ echo '&pp=on';} ?>" class="form-horizontal form-label-left" novalidate>
                                ...
                                $('#datetimepicker1').datetimepicker();
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <input type="hidden" name="id_req" value="<?php echo $id_req; ?>" />
                                                <input id="lokasi" type="text" name="lokasi" data-validate-length-range="4,20" class="optional form-control col-md-7 col-xs-12" data-toggle="tooltip" data-placement="bottom" title="<h2>Inputkan Lokasi</h2>
                                                ">
                                            </div>
                                        </div>
