    ...
    $sql1 = $konek->query("SELECT DISTINCT sensor.POSISIDETAIL,sensor.NAMALOKASI FROM sensor WHERE left(sensor.PARAMETER,7)='Current' AND POSISIDETAIL='$id'");
...
WHERE left(sensor.PARAMETER,7)='Current' AND POSISIDETAIL='$posisi'
